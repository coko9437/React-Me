...
//   return (
//     <>
//       <div>###MyComponent.jsx,나의 첫 함수형 컴포넌트</div>
//     </>
//   );
// };
// export default MyComponent; // 내보내기, 다른 곳에서 이용 가능.

// 방법2. 코드 스니펫을 이용해서, 작업. 단축어 -> rsc, rcc
// 함수형 컴포넌트 : rsc
// 클래스형 컴포넌트 : rcc
...
const MyComponent = ({ name = "기본값 이름입니다.", children }) => {
  return (
    <>
      <div>###MyComponent.jsx,나의 첫 함수형 컴포넌트 불러오기</div>
...
//     return (
//       <>
//         <div>###MyComponent.jsx,나의 첫 클래스형 컴포넌트 불러오기</div>
//         <h2>매개변수로 정의한 props(속성들) 를 사용하기, </h2>
//         <h3>props 객체에 있는 이름을 사용해보기 : {this.props.name}</h3>
//         <h3>================================================</h3>
